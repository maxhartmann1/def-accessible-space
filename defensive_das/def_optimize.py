...
def optimize_player_position(
    ...
    new_frame_list = df_frameified_simulated_position["new_frame"].unique()
    start_time = time.time()
    ...
    return (df_frameified_simulated_position, pitch_result_optimized, new_frame_list)


def get_new_frame_list(
    df_frameified,
    df_pre_frames,
    frame_list,
    player,
