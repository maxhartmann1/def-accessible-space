...
The package has a simple pandas interface that you can use to add xC (Expected completion) and team-level DAS (Dangerous accessible space) and AS (Accessible space) to your data. You will only need to tell it the required columns.
